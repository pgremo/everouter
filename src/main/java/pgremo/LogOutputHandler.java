...
public class LogOutputHandler extends Handler {
    ...
    static {
        ...
        PropertyEditorManager.registerEditor(Filter.class, ObjectInstancePropertyEditor.class);
        PropertyEditorManager.registerEditor(Formatter.class, ObjectInstancePropertyEditor.class);
    }
